...
namespace setup
{
    main_window_handle_t main_window(glfw_handle_t glfw_handle, std::string_view name, size_t width = 1280, size_t height = 720) noexcept;
}

struct main_window_context
{
    friend main_window_handle_t setup::main_window(glfw_handle_t glfw_handle, std::string_view name, size_t width, size_t height) noexcept;
