...
if(TARGET ImGuiNotify::ImGuiNotify)
    return()
endif()

message(CHECK_START "external: configuring ImGuiNotify")
...
add_subdirectory(
  "${CMAKE_CURRENT_LIST_DIR}/ImGuiNotify"
  "${CMAKE_CURRENT_BINARY_DIR}/_deps/ImGuiNotify-build"
  EXCLUDE_FROM_ALL
)
